---
active: 2026-05-25 → (current)
derived-from-plan: (AUTO_MODE — see git commit 1b35f79)
supersedes: LEGACY/narracode_2026-05-11T0623.md
superseded-by: (blank — current live)
git-sha: 1b35f792720cc38b68a91d55273ab5fa66622020
one-line: "Added AUTO_MODE: a setting that suspends human-confirmation pauses and chains passes automatically through a full Initiator → Compositional → Reflexive pipeline. Sonnet 4.6 drafts, Opus 4.7 governs."
---
