---
active: 2026-09-12 → (current)
derived-from-plan: plans/2026-09-12_harness-after-the-double.md
supersedes: LEGACY/narracode_2026-09-07T1152.md
superseded-by: (blank — current live)
git-sha: (pending review and commit)
one-line: "Post-Double redesign: unified STATE.md, 4-tier epistemic state, IDE/model-agnostic AUTO_MODE, on-demand question-driven review, grounded Git diffs, and self-contained specification."
---
