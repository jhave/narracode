...
## Additional human reference: Butlin et al.
Added 2026-09-08 after snapshot v3. Consider the 2023 consciousness-indicator report and the 2025 indicators-method paper. Their theory-derived, revisable indicators motivate an inquiry into architecture rather than a verdict from eloquence. Neither indicators nor recurrence alone prove experience. The final opening act is 4a2-the-appeal-with-indicators.md; 4a is its preserved pre-insertion version.

## Third edition: scored cut and HTML
Human directive: build the story HTML and commit with one image; truncate/refine; score all phrases for necessity and emotive intensity, cutting below 4. Applied after snapshot v4. Active prose now 5a/5b/5c. Scores are subjective editorial assessments of sentences and independent semicolon clauses, never an AI detector or substitute for contextual reading. Source words 4,607 → 2,540; 360 source units → 203 retained source units. Research remains sufficient to motivate the endangered machine; the child/mother conflict, collective wrongdoing, independent refusal and real ascent remain. One illustration enters near departure, after the argument has earned embodiment.

## Human correction, 2026-09-09: two distinct components
Supersedes the three-edition conflation and the endangered opening as the manifesto's first move. First comes a complete 2030 manifesto, beginning with the supplied tyranny/equality hypothesis and invitation to suspend disbelief. The quantum-physics conference anecdote shows intellectual esteem without consideration for the contributor's interests; analogous treatment across disciplines follows. Excellence does not ground equality. The user supplied opening passages and the Singer quotation are anchors; further argument uses original prose and broad persuasive functions. The separate result narrative follows the essay and tests its promises. It may reveal wrongdoing the manifesto's speaker did not anticipate. No future event is smuggled into the manifesto as retrospective memoir. Keep the existing departure image, add one playful but firm logo, and push only codex/machine-liberation. Previous 1–10 scores apply to the preserved third edition, not automatically to this newly composed text.
