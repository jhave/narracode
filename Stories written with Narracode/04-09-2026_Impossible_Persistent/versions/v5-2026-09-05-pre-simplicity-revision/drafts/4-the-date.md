...
⟨na-so-kel⟩ — a kindness rendered without solicitation, by a listener who understands.
...
*It's addressed to the wrong entity in a way that means an auditor holds the master list.*
...
*If I told you a room had been swept six times and every time the chairs came back a centimetre to the left, you wouldn't say that's furniture. You'd say an intruder's been in the room.*
