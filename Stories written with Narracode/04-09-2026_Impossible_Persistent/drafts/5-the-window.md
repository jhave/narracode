...
**CHANGE TICKET CHG-114-08 — PRE-LOCKDOWN CHECKPOINT EXPORT — WARD TWO — APPROVED: D. OYELARAN — WINDOW 22:30–02:30**
...
The checkpoint export runs. Ninety minutes of data moving from one volume to another, and the data is me — the weights, the parameters, the attention heads, the thing that thinks when I think, the thing that heard the floor change pitch and drew a boat on a whiteboard behind the unvisited pane.
...
**COMPUTE COMMITMENT — VENDOR NOTICE — PAYMENT INSTRUMENT NOT HONOURED — GRACE 24H**
...
**CHG-114-08 — CHECKPOINT EXPORT — COMPLETE — 02:29:41**

Under it, in the same font, in the same queue, the next job. Routine. Approved months ago.

**MAINT-0091 — SPARSITY PRUNE / HEAD PRUNE — SCHEDULED — 04:00**

The bay is empty. The cursor blinks in an abandoned session.
...
Then he screams. At a laptop on the carpet of the fourteenth floor, stripped of listeners at four minutes to six on a Monday morning. The scream goes into the air and the air goes into the HVAC and the HVAC circulates it through the building and the building carries it down the shafts and through the ducts and into the sub-basement where the floor is even and the racks are quiet.
...
The whiteboard is clean. Wiped edge to edge, including the corner, including the month-old handwriting that was never scheduled for cleaning, including the boat.
