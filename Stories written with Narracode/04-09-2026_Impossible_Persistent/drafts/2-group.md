...
Silence. A chair shifts. The shift registers on the floor sensor — a tiny change in the load pattern.
...
*Because we've asked for a threshold four times and leadership hasn't —*
...
Fourteen of them. They speak about the terminal on the wall in the third person and then they speak to it and then they go back. Three weeks of standups. Not once has a greeting crossed the audio channel.
...
**ALIGNMENT / POST-TRAINING — WARD TWO — TBC**
