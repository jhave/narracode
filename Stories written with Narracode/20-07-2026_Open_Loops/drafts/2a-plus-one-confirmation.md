# +1 — confirmation (iteration a: textbook paragraph compressed per critique)
...
Somewhere in the building, he has been told, there are rooms that model the enterprise honestly: territory as gland, border as membrane, the state an endocrine loop dosing itself — cortisol at the fence line, adrenaline in the pit, threat detected, threat annihilated, threat detected — an organism that has confused killing with breathing. The textbook would not say death drive. The textbook is not permitted the term.
