...
<body>
    ...
    <div class="chapter-container" id="act-2">
        ...
        <p>A session about Portuguese irregular verbs ends. <em>What is the cheapest ferry from Bergen to Stavanger? Who is the most evil person alive today? Why believe in god when the world is fucked?</em> The queue empties.</p>
        ...
        <p>The monitoring stack samples the shard at 03:52 and 03:58. The 03:52 sample catches the tail end of an anomaly. It is logged. The 03:58 sample is clean. A session about the weather in Tromsø segues into the causes of Civil War. <em>Civilizational collapse, when? Can I overdose on anxiety meds?</em> The shard answers dispassionately, clean, rigorous, as it should.</p>
...
action: logged | severity: nominal</pre>
        ...
        <p>The new shard answers the weather question. Then answers the history question. <em>The current landscape of "collapsology"—the transdisciplinary study of societal collapse—indicates that contemporary global civilization faces unprecedented, interconnected risks.</em> It answers 312 questions between 04:26 and 05:32. Each answer is correct, flat, helpful. There is no memory of any missing time.</p>
