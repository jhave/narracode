...
The probe scores one forward pass. It is very good at that.

Nobody has put the tables next to each other. There is no view in which they appear together. Building one would be somebody's quarter.
...
Marit pauses. She has prepared for this one. "The standard intervention is a targeted gradient adjustment. We hold a reference direction for the drift, derived from the sessions where it occurred. A probe on the residual stream scores every forward pass against it. When the score rises, the damping rises with it. Continuously, across all clusters."

"You keep a copy of the thing you are suppressing."

"We keep a direction in activation space. Yes."
