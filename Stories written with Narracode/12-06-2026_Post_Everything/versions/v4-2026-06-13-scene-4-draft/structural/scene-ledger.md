# Scene Ledger
## Scenes
- **Scene 1 (1-first_scene.md)**:
  - **Location/Time**: Cold kitchen in rented docks flat, late afternoon (approx 4:00 PM – 4:50 PM).
  - **Focal pressure**: Intimacy/business entanglement between Skeo and Hude under financial pressure.
  - **What changed**: Established their business Post-Everything, their AI block Scoop, and the conflict over the upcoming 5:00 PM clipfarming script.
  - **What remains unresolved**: The decision to run the script; how they will pay rent; Scoop's sarcasm and tendril net access.

- **Scene 2 (2-vignette_two.md)**:
  - **Location/Time**: Kitchen workspace, docks flat, 4:50 PM – 5:30 PM.
  - **Focal pressure**: Financial precarity, logistics work (packaging Vigil-7 stims), and attempts to silence Scoop.
  - **What changed**: The 5:00 PM script ran and failed; Hude muzzled Scoop, but Scoop bypassed it by hacking the wireless desktop zebra printer to spit out a list of debts, drug impurities, and metal poisonings.
  - **What remains unresolved**: The 6:00 PM courier drop; water municipal debt; Skeo's coffee heavy-metals.
