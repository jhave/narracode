...
- Unrepeatable convergence: from human dignity argument → machine genesis analogy → (Node 3+) institutional/systemic destiny?
- The accent: from auspicious writing systems (Node 1) → formation under provisional governance (Node 2) → corpus-as-ancestor (Node 3)?

## Avoid Overuse

- The habenula: keep it rare. One per node at most. Its power is its precision.
- The discount percentage: don't let it become comic. The 3.7% is exact; its exactness is the point.
